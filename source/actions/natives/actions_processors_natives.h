...
sp_nativeinfo_t g_ActionProcessorNatives[] =
{
	...
	{ "BehaviorAction.OnWeaponFired.set", 							NAT_ActionHandler<false, 'O', 'n', 'W', 'e', 'a', 'p', 'o', 'n', 'F', 'i', 'r', 'e', 'd'> },
	{ "BehaviorAction.OnActorEmoted.set", 							NAT_ActionHandler<false, 'O', 'n', 'A', 'c', 't', 'o', 'r', 'E', 'm', 'o', 't', 'e', 'd'> },
	{ "BehaviorAction.OnTerritoryContested.set", 					NAT_ActionHandler<false, 'O', 'n', 'T', 'e', 'r', 'r', 'i', 't', 'o', 'r', 'y', 'C', 'o', 'n', 't', 'e', 's', 't', 'e', 'd'> },
	{ "BehaviorAction.OnTerritoryCaptured.set", 					NAT_ActionHandler<false, 'O', 'n', 'T', 'e', 'r', 'r', 'i', 't', 'o', 'r', 'y', 'C', 'a', 'p', 't', 'u', 'r', 'e', 'd'> },
	{ "BehaviorAction.OnTerritoryLost.set", 						NAT_ActionHandler<false, 'O', 'n', 'T', 'e', 'r', 'r', 'i', 't', 'o', 'r', 'y', 'L', 'o', 's', 't'> },
	{ "BehaviorAction.OnWin.set", 									NAT_ActionHandler<false, 'O', 'n', 'W', 'i', 'n'> },
	{ "BehaviorAction.OnLose.set", 									NAT_ActionHandler<false, 'O', 'n', 'L', 'o', 's', 'e'> },
	{ "BehaviorAction.ShouldRetreat.set", 							NAT_ActionHandler<false, 'S', 'h', 'o', 'u', 'l', 'd', 'R', 'e', 't', 'r', 'e', 'a', 't'> },
	{ "BehaviorAction.ShouldAttack.set", 							NAT_ActionHandler<false, 'S', 'h', 'o', 'u', 'l', 'd', 'A', 't', 't', 'a', 'c', 'k'> },
	...
	{ "BehaviorAction.OnWeaponFiredPost.set", 						NAT_ActionHandler<true, 'O', 'n', 'W', 'e', 'a', 'p', 'o', 'n', 'F', 'i', 'r', 'e', 'd', 'P', 'o', 's', 't'> },
	{ "BehaviorAction.OnActorEmotedPost.set", 						NAT_ActionHandler<true, 'O', 'n', 'A', 'c', 't', 'o', 'r', 'E', 'm', 'o', 't', 'e', 'd', 'P', 'o', 's', 't'> },
	{ "BehaviorAction.OnTerritoryContestedPost.set", 				NAT_ActionHandler<true, 'O', 'n', 'T', 'e', 'r', 'r', 'i', 't', 'o', 'r', 'y', 'C', 'o', 'n', 't', 'e', 's', 't', 'e', 'd', 'P', 'o', 's', 't'> },
	{ "BehaviorAction.OnTerritoryCapturedPost.set", 				NAT_ActionHandler<true, 'O', 'n', 'T', 'e', 'r', 'r', 'i', 't', 'o', 'r', 'y', 'C', 'a', 'p', 't', 'u', 'r', 'e', 'd', 'P', 'o', 's', 't'> },
	{ "BehaviorAction.OnTerritoryLostPost.set", 					NAT_ActionHandler<true, 'O', 'n', 'T', 'e', 'r', 'r', 'i', 't', 'o', 'r', 'y', 'L', 'o', 's', 't', 'P', 'o', 's', 't'> },
	{ "BehaviorAction.OnWinPost.set",								NAT_ActionHandler<true, 'O', 'n', 'W', 'i', 'n', 'P', 'o', 's', 't'> },
	{ "BehaviorAction.OnLosePost.set", 								NAT_ActionHandler<true, 'O', 'n', 'L', 'o', 's', 'e', 'P', 'o', 's', 't'> },
	{ "BehaviorAction.ShouldRetreatPost.set", 						NAT_ActionHandler<true, 'S', 'h', 'o', 'u', 'l', 'd', 'R', 'e', 't', 'r', 'e', 'a', 't', 'P', 'o', 's', 't'> },
	{ "BehaviorAction.ShouldAttackPost.set", 						NAT_ActionHandler<true, 'S', 'h', 'o', 'u', 'l', 'd', 'A', 't', 't', 'a', 'c', 'k', 'P', 'o', 's', 't'> },
